...
--GO
--DECLARE	@badgeId		AS INT = 10 --good answer
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processGoodAnswer]
	(
...
WHERE
	...
	AND	answer.votes					>= 25 --good answer
...
GO
GRANT EXECUTE ON  [badges].[processGoodAnswer] TO [ProcessBadges]
GO
