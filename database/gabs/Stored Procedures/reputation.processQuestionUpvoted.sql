...
--DECLARE	@reputationActionId		INT = 11
--DECLARE	@reputation				INT = 10
--DECLARE	@days					INT = 300
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processQuestionUpvoted]
	(
...
--###
--[reputation].[processQuestionUpvoted]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processQuestionUpvoted] TO [processReputation]
GO
