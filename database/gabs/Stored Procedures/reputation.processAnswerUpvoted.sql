...
SET ANSI_NULLS OFF
GO
--DECLARE	@reputationActionId		INT = 7
--DECLARE	@reputation				INT = 10
--DECLARE	@days					INT = 300
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processAnswerUpvoted]
	(
...
--###
--[reputation].[processAnswerUpvoted]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processAnswerUpvoted] TO [processReputation]
GO
