...
--GO
--DECLARE	@badgeId		AS INT = 24 --25 questions upvoted
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 300
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processUpvotedQuestionsSilver]
	(
...
--###
--[badges].[processUpvotedQuestionsSilver]
--###
...
GO
GRANT EXECUTE ON  [badges].[processUpvotedQuestionsSilver] TO [ProcessBadges]
GO
