...
--GO
--DECLARE	@reputationActionId		INT = 2
--DECLARE	@reputation				INT = 1
--DECLARE	@days					INT = 10
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processAnsweredQuestion]
	(
...
--###
--[reputation].[processAnsweredQuestion]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processAnsweredQuestion] TO [processReputation]
GO
