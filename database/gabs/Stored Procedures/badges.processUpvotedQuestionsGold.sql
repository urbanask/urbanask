...
--GO
--DECLARE	@badgeId		AS INT = 26 --100 questions upvoted
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processUpvotedQuestionsGold]
	(
...
--###
--[badges].[processUpvotedQuestionsGold]
--###
...
GO
GRANT EXECUTE ON  [badges].[processUpvotedQuestionsGold] TO [ProcessBadges]
GO
