...
--GO
--DECLARE	@badgeId		AS INT = 30 --upvoted answers silver
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 300
--DECLARE	@count			AS INT = 1000

CREATE PROCEDURE [badges].[processUpvotedAnswersSilver]
	(
...
--###
--[badges].[processUpvotedAnswersSilver]
--###
...
GO
GRANT EXECUTE ON  [badges].[processUpvotedAnswersSilver] TO [ProcessBadges]
GO
