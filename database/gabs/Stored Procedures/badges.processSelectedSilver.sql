...
--GO
--DECLARE	@badgeId		AS INT = 21 --25 answers selected
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 3
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processSelectedSilver]
	(
...
GO
GRANT EXECUTE ON  [badges].[processSelectedSilver] TO [ProcessBadges]
GO
