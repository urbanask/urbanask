...
--GO
--DECLARE	@badgeId		AS INT = 27 --500 questions upvoted
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processUpvotedQuestionsDiamond]
	(
...
--###
--[badges].[processUpvotedQuestionsDiamond]
--###
...
SELECT
	...
	MAX( question.timestamp )					AS timestamp
...
GO
GRANT EXECUTE ON  [badges].[processUpvotedQuestionsDiamond] TO [ProcessBadges]
GO
