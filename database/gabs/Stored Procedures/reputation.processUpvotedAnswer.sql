...
SET ANSI_NULLS OFF
GO
--DECLARE	@reputationActionId		INT = 3
--DECLARE	@reputation				INT = 1
--DECLARE	@days					INT = 10
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processUpvotedAnswer]
	(
...
--###
--[reputation].[processUpvotedAnswer]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processUpvotedAnswer] TO [processReputation]
GO
