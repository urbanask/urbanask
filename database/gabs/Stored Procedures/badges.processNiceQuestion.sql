...
--GO
--DECLARE	@badgeId		AS INT = 7 --nice question
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processNiceQuestion]
	(
...
WHERE
	...
	AND	question.votes					>= 10 --nice question
...
GO
GRANT EXECUTE ON  [badges].[processNiceQuestion] TO [ProcessBadges]
GO
