...
SET ANSI_NULLS OFF
GO
--DECLARE	@reputationActionId		INT = 12
--DECLARE	@reputation				INT = -3
--DECLARE	@days					INT = 10
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processDownvotedAnswer]
	(
...
--###
--[reputation].[processDownvotedAnswer]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processDownvotedAnswer] TO [processReputation]
GO
