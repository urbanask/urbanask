...
--GO
--DECLARE	@badgeId		AS INT = 12 --great answer
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processGreatAnswer]
	(
...
WHERE
	...
	AND	answer.votes					>= 100 --great answer
...
GO
GRANT EXECUTE ON  [badges].[processGreatAnswer] TO [ProcessBadges]
GO
