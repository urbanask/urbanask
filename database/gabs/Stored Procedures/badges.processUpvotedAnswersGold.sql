...
--GO
--DECLARE	@badgeId		AS INT = 31 --upvoted answers gold
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 200
--DECLARE	@count			AS INT = 1000

CREATE PROCEDURE [badges].[processUpvotedAnswersGold]
	(
...
--###
--[badges].[processUpvotedAnswersGold]
--###
...
GO
GRANT EXECUTE ON  [badges].[processUpvotedAnswersGold] TO [ProcessBadges]
GO
