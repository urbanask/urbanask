...
--GO
--DECLARE	@badgeId		AS INT = 23 --500 answers selected
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 3
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processSelectedDiamond]
	(
...
GO
GRANT EXECUTE ON  [badges].[processSelectedDiamond] TO [ProcessBadges]
GO
