...
--GO
--DECLARE	@badgeId		AS INT = 29 --bounty gold
--DECLARE	@unlimited		AS INT = 0 --false
--DECLARE	@days			AS INT = 200
--DECLARE	@count			AS INT = 1000

CREATE PROCEDURE [badges].[processBountyDiamond]
	(
...
HAVING
	COUNT( reputation.reputationId )	>= 500
...
GO
GRANT EXECUTE ON  [badges].[processBountyDiamond] TO [ProcessBadges]
GO
