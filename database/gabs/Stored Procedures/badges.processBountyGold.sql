...
--GO
--DECLARE	@badgeId		AS INT = 28 --bounty silver
--DECLARE	@unlimited		AS INT = 0 --false
--DECLARE	@days			AS INT = 200
--DECLARE	@count			AS INT = 1000

CREATE PROCEDURE [badges].[processBountyGold]
	(
...
HAVING
	COUNT( reputation.reputationId )	>= 100
...
GO
GRANT EXECUTE ON  [badges].[processBountyGold] TO [ProcessBadges]
GO
