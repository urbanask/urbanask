...
--GO
--DECLARE	@badgeId		AS INT = 11 --great question
--DECLARE	@unlimited		AS INT = 1 --false
--DECLARE	@days			AS INT = 30
--DECLARE	@count			AS INT = 100

CREATE PROCEDURE [badges].[processGreatQuestion]
	(
...
WHERE
	...
	AND	question.votes					>= 100 --great question
...
GO
GRANT EXECUTE ON  [badges].[processGreatQuestion] TO [ProcessBadges]
GO
