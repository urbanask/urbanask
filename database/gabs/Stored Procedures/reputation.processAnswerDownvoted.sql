...
--DECLARE	@reputationActionId		INT = 13
--DECLARE	@reputation				INT = -10
--DECLARE	@days					INT = 10
--DECLARE	@count					INT = 1000
--DECLARE	@expirationDays			INT = 2

CREATE PROCEDURE [reputation].[processAnswerDownvoted]
	(
...
--###
--[reputation].[processAnswerDownvoted]
--###
...
GO
GRANT EXECUTE ON  [reputation].[processAnswerDownvoted] TO [processReputation]
GO
