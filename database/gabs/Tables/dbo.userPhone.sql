...
GRANT SELECT ON  [dbo].[userPhone] TO [login]
GRANT INSERT ON  [dbo].[userPhone] TO [login]
GRANT SELECT ON  [dbo].[userPhone] TO [verifyPhoneNumbers]
GRANT DELETE ON  [dbo].[userPhone] TO [verifyPhoneNumbers]
GO
