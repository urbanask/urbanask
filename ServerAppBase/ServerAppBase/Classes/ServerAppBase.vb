...
#Region "    variables "
    ...
    Private WithEvents _wait As Utility.ServerAppBase.Wait
...
#Region "    functions - private "
    ...
    Private Sub InitializeVariables()
        ...
        _wait = New Utility.ServerAppBase.Wait
    ...
    Private Sub RefreshParametersBase()
        ...
        _refreshRate = Parameters.Parameter.GetInt32Value("Schedule/RefreshRate")
        _shutdownApplication = Parameters.Parameter.GetBooleanValue("ShutdownApplication")
        _startTime = Parameters.Parameter.GetValue("Schedule/StartTime", True)
        _stopTime = Parameters.Parameter.GetValue("Schedule/StopTime", True)
        _lastRunDate = Parameters.Parameter.GetValue("Schedule/LastRunDate", True)

        enabled = Parameters.Parameter.GetBooleanValue("Enabled")
        ...
        _threadMillisecondsTimeout = Parameter.GetInt32Value("ThreadMillisecondsTimeout")
    ...
    Private Sub SetSystemTrayIcon( _
        ...
        Dim wait As New Utility.ServerAppBase.Wait
