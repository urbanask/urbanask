...
<head>
    ...
    <meta property="og:description"                     content="The addicting game of helping people find things." />
    <meta property="og:image"                           content="http://urbanAsk.com/images/share-logo.png" />
    <meta itemprop="name"                               content="urbanAsk" />
    <meta itemprop="description"                        content="The addicting game of helping people find things." />
    <meta itemprop="image"                              content="http://urbanAsk.com/images/share-logo.png" />
...
//            postData2 = atob( '<% =getPostData2() %>' ),
        ...
        window.onload = function () {
            ...
            if ( postData ) { //from facebook

                window.location.href = APP_URL;

            } else if ( window.navigator.userAgent.indexOf( 'iPhone' ) > -1 && !window.navigator.standalone ) {
                ...
                window.localStorage.removeItem( 'beta' ); //remove this eventually
                window.location.href = APP_URL;
