    ...
    window.onload = function () {
            ...
            window.setTimeout( function () {
                ...
                if ( answerItem ) {
                    ...
                    if ( select.length && !select[0].hasClass( 'hide' ) ) {
                        ...
                        showPage( 'answer-page', { id: answerItem.getDataset( 'id' ), answerLetter: answerItem.getDataset( 'letter' ) } );
        ...
        function goBack( event ) {
            ...
            var previousIndex = _pages.length() - 2,
                page = _pages.data[previousIndex].name,
                options = _pages.data[previousIndex].options;

            _pages.remove(); //remove current page
            _pages.remove(); //remove previous page (added back in showPage)
        ...
        function loadAccount() {
            ...
            ajax( resource, {
                ...
                "success": function ( data, status ) {
                    ...
                    window.setLocalStorage( 'account', data );
        ...
        function loadCachedData() {
            ...
            var questions = window.getLocalStorage( 'questions' ),
                ...
                account = window.getLocalStorage( 'account' );
        ...
        function setupGeolocation() {
            ...
            _geoTimer = window.setInterval( setGeolocation, 120000 ); //every 2 minutes
        ...
        function showPage( page, options ) {
            ...
            switch ( page ) {
                ...
                case 'answer-page':
                    ...
                    _pages.add( page, { id: options.id, caption: STRINGS.backButtonAnswer, answerLetter: options.answerLetter } )
                    ...
                    showToolbar( 'answer', { "answerId": options.id } );

                    if ( options.id && options.answerLetter ) {

                        showAnswer( _selectedQuestion, options.id, options.answerLetter );
                ...
                case 'question-page':
                    ...
                    _pages.add( page, { id: options.id, caption: STRINGS.backButtonQuestion } )
                    ...
                    if ( isMyQuestion( _selectedQuestion ) ) {
                        ...
                        showToolbar( 'question', { "questionId": options.id } );
                ...
                case 'user-page':
                    ...
                    if ( options.id == _account[ACCOUNT_COLUMNS.userId] ) { //my user page

                        _pages.replace( page, { id: options.id, caption: STRINGS.backButtonUser } )

                        showEditAccount();

                    } else {

                        _pages.add( page, { id: options.id, caption: STRINGS.backButtonUser } )
                ...
                switch ( item.id ) {
                    ...
                    case 'select-answers-button':
                        ...
                        if ( selects.length == 0 ) {
                            ...
                            if ( selects[0].hasClass( 'hide' ) ) {
                                ...
                                showAnswersSelect( _selectedQuestion );
                    ...
                    case 'vote-down-button':
                        ...
                        if ( voteDown.length && voteDown[0].hasClass( 'hide' ) ) {
                            ...
                            showVoteDown( _selectedQuestion );
