...
Public Class serverApp : Inherits Utility.ServerAppBase.ServerAppBase
    ...
    Private Const GOOGLE_MAPS_URL As String = "http://maps.googleapis.com/maps/api/geocode/json?address=%1&sensor=false"
            ...
            Using tweets As Data.SqlClient.SqlDataReader = command.ExecuteReader()
                ...
                While (tweets.Read())
                    ...
                    If tweet.ToLower.Contains(_hashTag) Then
                        ...
                        Dim fullTweet As String = tweet.Replace(_hashTag, ""),
                            location As String = "",
                            latitude As Double,
                            longitude As Double,
                            region As String = "",
                            verifiedLocation As String = ""

                        If fullTweet.ToLower.Contains("@") Then

                            location = fullTweet.Split("@"c)(1).Trim()
                    ...
                    End If
                    'if #urbanask, check "where can I find ____ @ location", post. else, treat like others
                    'check location, if valid, tweetPending
